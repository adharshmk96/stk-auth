...
// DeactivateSession provides a mock function with given fields: id
func (_m *AccountStorage) DeactivateSession(id string) error {
	ret := _m.Called(id)
...
func (_m *AccountStorage) GetAccountBySessionID(id string) (*domain.Account, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetAccountBySessionID")
	}
...
func (_m *AccountStorage) StoreAccount(account *domain.Account) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for StoreAccount")
	}
